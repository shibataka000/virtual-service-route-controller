...
type VirtualServiceBaseSpec struct {
	...
	// Foo is an example field of VirtualServiceBase. Edit VirtualServiceBase_types.go to remove/update
...
func init() {
	SchemeBuilder.Register(&VirtualServiceBase{}, &VirtualServiceBaseList{})
}
