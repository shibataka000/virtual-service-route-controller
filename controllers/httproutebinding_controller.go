...
// +kubebuilder:rbac:groups=virtualservicecomponent.shibataka000.com,resources=httproutebindings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=virtualservicecomponent.shibataka000.com,resources=httproutebindings/status,verbs=get;update;patch
